(() => {
  ...
  function renderAnalytics() {
    ...
    renderLeaderboard(el.pointsLeaderboard, (p) => p.points, (v) => T.formatNumber(v), "No points awarded yet.");
  }
  ...
  function renderReports() {
    ...
    renderReportPanel(el.pendingPanel, pending, "Nothing pending right now.");
    ...
    renderReportPanel(el.trashPanel, trash, "Trash is empty.");
  }
